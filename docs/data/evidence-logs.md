...
Evidence Logs trace the actions performed within Event Data during the creation of an Event. They should be read in conjunction with the Evidence Records. Evidence Logs are collected daily and are made up of a sequence of entries, each entry describing a particular action that was taken. Each Evidence Log corresponds to a day's worth of activity, and typically comprises a few million entries.
