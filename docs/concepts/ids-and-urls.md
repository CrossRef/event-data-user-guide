...
## Landing Page to DOI mappings - on whose authority?
...
We maintain a list of publisher domains (see the [artifact registry](../artifact-registry)). This list is generated by following a sample of DOIs to see where they point to. We will not attempt to look at the Landing Page that is not on this list.
